...
const STAGE_POSE = {
  ...
  company: { lean: 0.15, headTilt: 0.2, bobSpeed: 1.4 }, 
  parallel: { lean: 0.05, headTilt: -0.05, bobSpeed: 2.2 }, 
  decision: { lean: -0.05, headTilt: -0.1, bobSpeed: 0.8 }, 
  done: { lean: 0, headTilt: 0.08, bobSpeed: 1 }, 
};
